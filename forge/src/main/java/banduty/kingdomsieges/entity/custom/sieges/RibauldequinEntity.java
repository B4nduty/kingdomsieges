...
public class RibauldequinEntity extends AbstractSiegeEntity implements GeoEntity {
    ...
    private static final SiegeProperties PROPERTIES = SiegeProperties.builder("ribauldequin")
            ...
            .shootSound(ModSounds.CANNON_CLOSE.get())
            .moveSoundDelay(150)
            .moveSoundRange(30.0)
    ...
    private void fireSingleShot(ServerLevel serverLevel, float angleOffset) {
        ...
        spawnParticleTrail(serverLevel, direction.normalize(), mouthPos, ModParticles.MUZZLES_SMOKE_PARTICLE.get(), 20, 0.2f, 0.0005f, 5);
        spawnParticleTrail(serverLevel, direction.normalize(), mouthPos, ModParticles.MUZZLES_FLASH_PARTICLE.get(), 1, 0f, 0.1f, 6);
    }
