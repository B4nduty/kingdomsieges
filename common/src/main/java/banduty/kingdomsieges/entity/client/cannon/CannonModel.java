...
public class CannonModel extends GeoModel<CannonEntity> {
    ...
    public ResourceLocation getModelResource(CannonEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Kingdomsieges.MOD_ID, "geo/cannon.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(CannonEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Kingdomsieges.MOD_ID, "textures/entity/cannon.png");
    }

    @Override
    public ResourceLocation getAnimationResource(CannonEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Kingdomsieges.MOD_ID, "animations/cannon.animation.json");
    }
