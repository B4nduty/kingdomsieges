...
public class MantletModel extends GeoModel<MantletEntity> {
    ...
    public ResourceLocation getModelResource(MantletEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Kingdomsieges.MOD_ID, "geo/mantlet.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(MantletEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Kingdomsieges.MOD_ID, "textures/entity/mantlet.png");
    }

    @Override
    public ResourceLocation getAnimationResource(MantletEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Kingdomsieges.MOD_ID, "animations/mantlet.animation.json");
    }
