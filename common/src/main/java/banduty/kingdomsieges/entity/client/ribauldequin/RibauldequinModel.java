...
public class RibauldequinModel extends GeoModel<RibauldequinEntity> {
    ...
    public ResourceLocation getModelResource(RibauldequinEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Kingdomsieges.MOD_ID, "geo/ribauldequin.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(RibauldequinEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Kingdomsieges.MOD_ID, "textures/entity/ribauldequin.png");
    }

    @Override
    public ResourceLocation getAnimationResource(RibauldequinEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Kingdomsieges.MOD_ID, "animations/ribauldequin.animation.json");
    }
