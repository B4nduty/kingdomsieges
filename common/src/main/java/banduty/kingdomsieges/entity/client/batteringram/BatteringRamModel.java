...
public class BatteringRamModel extends GeoModel<BatteringRamEntity> {
    ...
    public ResourceLocation getModelResource(BatteringRamEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Kingdomsieges.MOD_ID, "geo/battering_ram.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(BatteringRamEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Kingdomsieges.MOD_ID, "textures/entity/battering_ram.png");
    }

    @Override
    public ResourceLocation getAnimationResource(BatteringRamEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath(Kingdomsieges.MOD_ID, "animations/battering_ram.animation.json");
    }
